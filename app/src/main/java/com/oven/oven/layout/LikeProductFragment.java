...
public class LikeProductFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_like_product, container, false);

        recyclerView = (RecyclerView) rootView.findViewById(R.id.recycler_item_like_list);
    ...
    public void getProductList(){
        ...
        Call<ProductResList> call = service.postProductLikeList(MainActivity.UID);
            ...
            public void onResponse(Call<ProductResList> call, final Response<ProductResList> response) {
                if(response.isSuccessful()) {
                    if(response.body()!=null){
                        ...
                        adapter = new ItemListAdapter(getContext(), productList);
                        recyclerView.setAdapter(adapter);
                        //Toast.makeText(getContext(), "Called Like List", Toast.LENGTH_LONG).show();
                    }
                    return;
                }
